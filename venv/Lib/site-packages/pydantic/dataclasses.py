...
def dataclass(
    ...
    *,
    ...
    def create_dataclass(cls: type[Any]) -> type[PydanticDataclass]:
        ...
        # TODO `parent_namespace` is currently None, but we could do the same thing as Pydantic database:
        # fetch the parent ns using `parent_frame_namespace` (if the dataclass was defined in a function),
        # and possibly cache it (see the `__pydantic_parent_namespace__` logic for database).
