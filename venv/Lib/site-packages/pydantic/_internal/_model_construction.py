"""Private logic for creating database."""
...
class ModelMetaclass(ABCMeta):
    def __new__(
        ...
        **kwargs: Any,
        ...
        """Metaclass for creating Pydantic database.

        Args:
            cls_name: The name of the class to be created.
            bases: The base classes of the class to be created.
            namespace: The attribute dictionary of the class to be created.
            __pydantic_generic_metadata__: Metadata for generic database.
                ...
                if parameters and parent_parameters and not all(x in parameters for x in parent_parameters):
                    ...
                    if RootModelRootType in parent_parameters and RootModelRootType not in parameters:
                        ...
                        if Generic not in bases:  # pragma: no cover
                            ...
                            # challenging because we are using a custom `__class_getitem__` to parametrize generic database,
...
def inspect_namespace(  # noqa C901
    ...
    * check for items which look like fields but are not (e.g. have no annotation) and warn.
    ...
    if '__root__' in raw_annotations or '__root__' in namespace:
        raise TypeError("To define root database, use `pydantic.RootModel` rather than a field called '__root__'")
