...
class GenerateJsonSchema:
    ...
    def field_title_should_be_set(self, schema: CoreSchemaOrField) -> bool:
        ...
        if _core_utils.is_core_schema_field(schema):
            ...
            if schema.get('ref'):  # things with refs, such as database and enums, should not have titles set
                return False
    ...
    def handle_ref_overrides(self, json_schema: JsonSchemaValue) -> JsonSchemaValue:
        ...
        if '$ref' in json_schema:
            ...
            if referenced_json_schema is None:
                # This can happen when building schemas for database with not-yet-defined references.
...
def models_json_schema(
    ...
    *,
    ...
    """Utility function to generate a JSON Schema for multiple database.
