...
class FieldInfo(_repr.Representation):
    ...
    def from_annotated_attribute(
        ...
        # instance's type to be preserved when constructing new database with its subclasses as assignments.
...
class ModelPrivateAttr(_repr.Representation):
    """A descriptor for private attributes in class database.
...
def PrivateAttr(
    ...
    *,
    ...
    """!!! abstract "Usage Documentation"
        [Private Model Attributes](../concepts/database.md#private-model-attributes)
...
def computed_field(
    ...
    *,
    ...
    Decorator to include `property` and `cached_property` when serializing database or dataclasses.
