...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        from_attributes: Whether to use attributes for database, dataclasses, and tagged union keys.
        ...
        revalidate_instances: Whether instances of database and dataclasses should re-validate. Default is 'never'.
    ...
    # used for database, dataclasses, and tagged union keys
...
def model_schema(
    ...
    *,
    ...
    Args:
        ...
        revalidate_instances: whether instances of database and dataclasses (including subclass instances)
...
def definition_reference_schema(
    ...
    database and also when you want to define validators separately from the main schema, e.g.:
