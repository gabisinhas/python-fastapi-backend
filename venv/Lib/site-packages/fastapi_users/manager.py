...
class BaseUserManager(Generic[models.UP, models.ID]):
    ...
    def parse_id(self, value: Any) -> models.ID:
        """
        Parse a value into a correct database.ID instance.

        :param value: The value to parse.
        :raises InvalidID: The database.ID value is invalid.
        :return: A database.ID object.
        """
    ...
    async def get(self, id: models.ID) -> models.UP:
        ...
        :return: A user of type database.UP.
        """
    ...
    async def create(
        ...
        :return: A new user of type database.UP.
        """
    ...
    async def oauth_callback(
        self: "BaseUserManager[database.UOAP, database.ID]",
        oauth_name: str,
        access_token: str,
        account_id: str,
        account_email: str,
        ...
        *,
        ...
        Defaults to False.
        :return: A user of type database.UOAP.
        """
        oauth_account_dict = {
    ...
    async def verify(self, token: str, request: Request | None = None) -> models.UP:
        ...
        :raises UserAlreadyVerified: The user is already verified.
        :return: A verified user of type database.UP.
        """
        try:
            data = decode_jwt(
                token,
    ...
    async def reset_password(
        ...
        :return: The user of type database.UP with updated password.
        """
        try:
            data = decode_jwt(
                token,
    ...
    async def update(
        ...
        :param request: Optional FastAPI request that
        triggered the operation, defaults to None.
        :return: The updated user of type database.UP.
        """
        if safe:
    ...
    async def authenticate(
        ...
        :return: The authenticated user of type database.UP if credentials are valid,
        otherwise None.
        """
        try:
